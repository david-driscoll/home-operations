...
#:package ZiggyCreatures.FusionCache@2.9.0
#:package NeoSmart.Caching.Sqlite.AspNetCore@9.0.3
#:package ZiggyCreatures.FusionCache.Serialization.SystemTextJson@2.9.0
...
app.MapGet("/player_api.php", async (string? action, string? category_id, int? vod_id, int? series_id, int? limit, [FromServices] XcProxyConfiguration cfg, [FromServices] PlaylistData playlistData, [FromServices] TmdbEnricher tmdbClient) =>
{
  ...
  return action switch
  {
    ...
    "get_live_streams" => Results.Ok(new List<XtreamChannel>() { new XtreamChannel(1, "None", "1", "None", "url", "url") }),
