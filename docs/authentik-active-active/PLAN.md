...
| 5 | authentik on equestria (staging hostname), media on Garage | `kubernetes/apps/stargate-command/authentik`, `stacks/system/garage.ts` | Both sites serve logins against the one DB |
