...
async function getPackage() {
    if (_packageRef === undefined) {
        ...
        if (_packageRef === undefined) {
            ...
            params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL21jZml0ejIvcGJzIiwidmVyc2lvbiI6IjAuMi4xIn19"), c => c.charCodeAt(0)));
