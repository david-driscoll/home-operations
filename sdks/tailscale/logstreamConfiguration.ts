...
export class LogstreamConfiguration extends pulumi.CustomResource {
    ...
    /**
     * The AWS External ID that Tailscale supplies when authenticating using role-based authentication. Required if destination_type is 's3' and s3_authentication_type is 'rolearn'. This can be obtained via the tailscale.AwsExternalId resource.
     */
    ...
    constructor(name: string, argsOrState?: LogstreamConfigurationArgs | LogstreamConfigurationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogstreamConfiguration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
