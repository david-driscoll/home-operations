...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'uptimekuma';
    ...
    constructor(name: string, args: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["insecureHttps"] = pulumi.output(args?.insecureHttps).apply(JSON.stringify);
    ...
    terraformConfig(): pulumi.Output<{[key: string]: any}> {
        const result: pulumi.Output<Provider.TerraformConfigResult> = pulumi.runtime.call("pulumi:providers:uptimekuma/terraformConfig", {
            "__self__": this,
