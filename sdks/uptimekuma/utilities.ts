...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("uptimekuma");
			params.setVersion("0.0.12");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2tpbGwzci1xdWVlbi91cHRpbWVrdW1hIiwidmVyc2lvbiI6IjAuMC4xMiJ9fQ=="), c => c.charCodeAt(0)));
