...
export class SettingCountry extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SettingCountryState, opts?: pulumi.CustomResourceOptions): SettingCountry {
        return new SettingCountry(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'unifi:index/settingCountry:SettingCountry';

    /**
     * Returns true if the given object is an instance of SettingCountry.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SettingCountry {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SettingCountry.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: SettingCountryArgs | SettingCountryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SettingCountryState | undefined;
            resourceInputs["code"] = state?.code;
            resourceInputs["codeNumeric"] = state?.codeNumeric;
            resourceInputs["site"] = state?.site;
        } else {
            const args = argsOrState as SettingCountryArgs | undefined;
        ...
        super(SettingCountry.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
