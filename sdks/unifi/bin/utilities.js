...
async function getPackage() {
    if (_packageRef === undefined) {
        ...
        if (_packageRef === undefined) {
            ...
            params.setVersion("0.41.25");
            params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3ViaXF1aXRpLWNvbW11bml0eS91bmlmaSIsInZlcnNpb24iOiIwLjQxLjI1In19"), c => c.charCodeAt(0)));
