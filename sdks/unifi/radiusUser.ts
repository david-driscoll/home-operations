...
export class RadiusUser extends pulumi.CustomResource {
    /**
     * Get an existing RadiusUser resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RadiusUserState, opts?: pulumi.CustomResourceOptions): RadiusUser {
        return new RadiusUser(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'unifi:index/radiusUser:RadiusUser';

    /**
     * Returns true if the given object is an instance of RadiusUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RadiusUser {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RadiusUser.__pulumiType;
    }
    ...
    declare public readonly timeouts: pulumi.Output<outputs.RadiusUserTimeouts | undefined>;
    /**
    ...
    /**
     * Create a RadiusUser resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RadiusUserArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RadiusUserArgs | RadiusUserState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RadiusUserState | undefined;
            ...
            const args = argsOrState as RadiusUserArgs | undefined;
        ...
        super(RadiusUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RadiusUser resources.
 */
export interface RadiusUserState {
    /**
     * The name of the account.
     */
    ...
    timeouts?: pulumi.Input<inputs.RadiusUserTimeouts | undefined>;
    /**
     * The tunnel configuration type. Can be `vpn`, `802.1x`, or `custom`.
     */
...
/**
 * The set of arguments for constructing a RadiusUser resource.
 */
export interface RadiusUserArgs {
    /**
     * The name of the account.
     */
    name?: pulumi.Input<string | undefined>;
