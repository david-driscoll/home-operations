...
export class WireguardPeer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'unifi:index/wireguardPeer:WireguardPeer';
    ...
    declare public readonly timeouts: pulumi.Output<outputs.WireguardPeerTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: WireguardPeerArgs | WireguardPeerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.interfaceIp === undefined && !opts.urn) {
                throw new Error("Missing required property 'interfaceIp'");
            }
...
export interface WireguardPeerState {
    ...
    timeouts?: pulumi.Input<inputs.WireguardPeerTimeouts | undefined>;
}
