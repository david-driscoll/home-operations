...
export declare class PropertyMappingSourceSaml extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PropertyMappingSourceSamlState, opts?: pulumi.CustomResourceOptions): PropertyMappingSourceSaml;
    /**
     ...
     */
    static isInstance(obj: any): obj is PropertyMappingSourceSaml;
    readonly expression: pulumi.Output<string>;
    readonly name: pulumi.Output<string>;
    readonly propertyMappingSourceSamlId: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=propertyMappingSourceSaml.d.ts.map