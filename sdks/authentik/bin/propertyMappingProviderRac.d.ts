...
export declare class PropertyMappingProviderRac extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PropertyMappingProviderRacState, opts?: pulumi.CustomResourceOptions): PropertyMappingProviderRac;
    /**
     ...
     */
    static isInstance(obj: any): obj is PropertyMappingProviderRac;
    readonly expression: pulumi.Output<string | undefined>;
    readonly name: pulumi.Output<string>;
    readonly propertyMappingProviderRacId: pulumi.Output<string>;
    /**
