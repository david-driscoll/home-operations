...
export declare class EventRule extends pulumi.CustomResource {
     ...
     */
    readonly destinationEventUser: pulumi.Output<boolean | undefined>;
    /**
     * Group to send notification to
     */
    readonly destinationGroup: pulumi.Output<string | undefined>;
    readonly eventRuleId: pulumi.Output<string>;
