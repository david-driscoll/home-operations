...
export declare class PolicyExpiry extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyExpiryState, opts?: pulumi.CustomResourceOptions): PolicyExpiry;
    /**
     * Returns true if the given object is an instance of PolicyExpiry.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PolicyExpiry;
    readonly days: pulumi.Output<number>;
    /**
     * Defaults to `false`.
     */
    readonly denyOnly: pulumi.Output<boolean | undefined>;
    /**
     * Defaults to `false`.
     */
    readonly executionLogging: pulumi.Output<boolean | undefined>;
    readonly name: pulumi.Output<string>;
    readonly policyExpiryId: pulumi.Output<string>;
    /**
