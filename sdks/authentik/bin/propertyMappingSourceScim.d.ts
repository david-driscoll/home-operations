...
export declare class PropertyMappingSourceScim extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PropertyMappingSourceScimState, opts?: pulumi.CustomResourceOptions): PropertyMappingSourceScim;
    /**
     ...
     */
    static isInstance(obj: any): obj is PropertyMappingSourceScim;
    readonly expression: pulumi.Output<string>;
    readonly name: pulumi.Output<string>;
    readonly propertyMappingSourceScimId: pulumi.Output<string>;
    /**
