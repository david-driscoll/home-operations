...
export declare class PolicyEventMatcher extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyEventMatcherState, opts?: pulumi.CustomResourceOptions): PolicyEventMatcher;
    /**
     * Returns true if the given object is an instance of PolicyEventMatcher.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PolicyEventMatcher;
    ...
    readonly policyEventMatcherId: pulumi.Output<string>;
    /**
