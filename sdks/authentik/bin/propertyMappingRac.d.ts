...
export declare class PropertyMappingRac extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PropertyMappingRacState, opts?: pulumi.CustomResourceOptions): PropertyMappingRac;
    /**
     * Returns true if the given object is an instance of PropertyMappingRac.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PropertyMappingRac;
    readonly expression: pulumi.Output<string | undefined>;
    readonly name: pulumi.Output<string>;
    readonly propertyMappingRacId: pulumi.Output<string>;
    /**
