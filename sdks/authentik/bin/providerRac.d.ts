...
export declare class ProviderRac extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProviderRacState, opts?: pulumi.CustomResourceOptions): ProviderRac;
    /**
     * Returns true if the given object is an instance of ProviderRac.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProviderRac;
     ...
     */
    readonly connectionExpiry: pulumi.Output<string | undefined>;
    readonly name: pulumi.Output<string>;
    readonly propertyMappings: pulumi.Output<string[] | undefined>;
    readonly providerRacId: pulumi.Output<string>;
    /**
