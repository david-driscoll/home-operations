...
export declare class PropertyMappingSourceKerberos extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PropertyMappingSourceKerberosState, opts?: pulumi.CustomResourceOptions): PropertyMappingSourceKerberos;
    /**
     ...
     */
    static isInstance(obj: any): obj is PropertyMappingSourceKerberos;
    readonly expression: pulumi.Output<string>;
    readonly name: pulumi.Output<string>;
    readonly propertyMappingSourceKerberosId: pulumi.Output<string>;
    /**
