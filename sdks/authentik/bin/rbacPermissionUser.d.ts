...
export declare class RbacPermissionUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RbacPermissionUserState, opts?: pulumi.CustomResourceOptions): RbacPermissionUser;
    /**
     * Returns true if the given object is an instance of RbacPermissionUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RbacPermissionUser;
    /**
     * Allowed values:
    ...
    readonly rbacPermissionUserId: pulumi.Output<string>;
