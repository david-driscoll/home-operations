...
export declare class PropertyMappingNotification extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PropertyMappingNotificationState, opts?: pulumi.CustomResourceOptions): PropertyMappingNotification;
    /**
     ...
     */
    static isInstance(obj: any): obj is PropertyMappingNotification;
    readonly expression: pulumi.Output<string>;
    readonly name: pulumi.Output<string>;
    readonly propertyMappingNotificationId: pulumi.Output<string>;
    /**
