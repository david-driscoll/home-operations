...
exports.CertificateKeyPair = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class CertificateKeyPair extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new CertificateKeyPair(name, state, { ...opts, id: id });
    }
    /**
...
exports.CertificateKeyPair = CertificateKeyPair;
/** @internal */
CertificateKeyPair.__pulumiType = 'authentik:index/certificateKeyPair:CertificateKeyPair';
//# sourceMappingURL=certificateKeyPair.js.map