...
exports.PropertyMappingNotification = void 0;
...
class PropertyMappingNotification extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new PropertyMappingNotification(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'authentik:index/propertyMappingNotification:PropertyMappingNotification';
    /**
