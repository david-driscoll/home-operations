...
exports.StagePrompt = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class StagePrompt extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new StagePrompt(name, state, { ...opts, id: id });
    }
    /**
...
exports.StagePrompt = StagePrompt;
/** @internal */
StagePrompt.__pulumiType = 'authentik:index/stagePrompt:StagePrompt';
//# sourceMappingURL=stagePrompt.js.map