...
export declare class CertificateKeyPair extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CertificateKeyPairState, opts?: pulumi.CustomResourceOptions): CertificateKeyPair;
    /**
     * Returns true if the given object is an instance of CertificateKeyPair.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CertificateKeyPair;
    readonly certificateData: pulumi.Output<string>;
    readonly certificateKeyPairId: pulumi.Output<string>;
    readonly keyData: pulumi.Output<string | undefined>;
...
//# sourceMappingURL=certificateKeyPair.d.ts.map