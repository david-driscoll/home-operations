...
export class User extends pulumi.CustomResource {
     ...
     */
    declare public readonly deactivateOnDestroy: pulumi.Output<boolean>;
    /**
    ...
    constructor(name: string, argsOrState?: UserArgs | UserState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["deactivateOnDestroy"] = state?.deactivateOnDestroy;
            ...
            resourceInputs["deactivateOnDestroy"] = args?.deactivateOnDestroy;
...
export interface UserState {
     ...
     * Deactivate the user instead of delete?
     */
    deactivateOnDestroy?: pulumi.Input<boolean | undefined>;
    /**
     * Description of the user.
     */
