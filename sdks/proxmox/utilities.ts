...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setVersion("2.9.14");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3RlbG1hdGUvcHJveG1veCIsInZlcnNpb24iOiIyLjkuMTQifX0="), c => c.charCodeAt(0)));
