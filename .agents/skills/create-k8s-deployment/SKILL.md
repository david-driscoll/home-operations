...
Your goal is to create a production-ready Kubernetes deployment following the established patterns in this repository's `kubernetes/` tree.
...
- **Postgres credentials**: Generated by repository update script (`mise run update`)
