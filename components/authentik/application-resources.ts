    ...
    if (authentikDefinition.providerOauth2) {
      ...
      const oidcCredentials = new OnePasswordItem(`${definition.metadata.name}-oidc-credentials`, {
        ...
        fields: pulumi.output({
          ...
          authorization_url: { label: "Authorization URL", value: `${clusterDefinition.spec.domain}/application/o/authorize/`, type: TypeEnum.String },
          token_url: { label: "Token URL", value: `${clusterDefinition.spec.domain}/application/o/token/`, type: TypeEnum.String },
          userinfo_url: { label: "Userinfo URL", value: `${clusterDefinition.spec.domain}/application/o/userinfo/`, type: TypeEnum.String },
          revoke_url: { label: "Revoke URL", value: `${clusterDefinition.spec.domain}/application/o/revoke/`, type: TypeEnum.String },
          issuer: { label: "Issuer", value: `${clusterDefinition.spec.domain}/application/o/${slug}/`, type: TypeEnum.String },
          end_session_url: { label: "End Session URL", value: `${clusterDefinition.spec.domain}/application/o/${slug}/end-session/`, type: TypeEnum.String },
          jwks_url: { label: "JWKS URL", value: `${clusterDefinition.spec.domain}/application/o/${slug}/jwks/`, type: TypeEnum.String },
